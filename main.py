...
days_in_house1 = int(input(f'How many days did {name1} stay in a house during the bill period?: '))

name2 = input('What is the name of the other flatmate?: ')
days_in_house2 = int(input(f'How many days did {name2} stay in a house during the bill period?: '))
